...
bool OMXPlayerVideo::Open(COMXStreamInfo &hints, OMXClock *av_clock, OMX_TextureData*& textureData, bool deinterlace, bool mpeg, bool hdmi_clock_sync, bool use_thread,
                             float display_aspect, float queue_size, float fifo_size)
{
